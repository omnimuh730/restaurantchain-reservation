...
@Composable
fun QrPayScreen(modifier: Modifier = Modifier) {
    Column(
        modifier = modifier
            .fillMaxSize()
            .padding(16.dp),
        ...
        DsTopBar(title = stringResource(I18nR.string.title_qrpay))
        DsCard {
            Text(stringResource(I18nR.string.desc_qrpay), style = MaterialTheme.typography.bodyLarge)
        }
    }
}
