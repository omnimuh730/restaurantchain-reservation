...
private fun mockNewsArticles(): List<NewsItem> {
    ...
    return listOf(
        ...
        NewsItem(
            ...
            title = "Chef Daniel Park Opens Smokehouse Social in Hayes Valley",
            summary = "A 12-seat counter brings wood-fired BBQ and seasonal California produce to the neighborhood.",
            body = "After three years cooking in Austin and Nashville, chef Daniel Park returns to San Francisco with Smokehouse Social — a 12-seat counter dedicated to whole-animal BBQ and farm-driven sides. The 14-course menu highlights dry-aged brisket, house pickles, and a live-fire hearth. Booking opens Friday at 10 AM and is expected to fill quickly.",
            ...
            readMinutes = 3,
            tags = listOf("Opening", "BBQ", "Tasting Menu"),
        ),
        NewsItem(
            id = "n-103",
